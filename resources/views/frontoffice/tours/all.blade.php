...
<style>
    ...
    #tours {
        margin-top: 30px;
        background: url('{{ asset('images/bg/cameleon.jpg') }}') no-repeat center center / cover;
        position: relative;
        z-index: 0;
    }
</style>
            ...
            <div class="col-md-4">
                <div class="card tour-card h-100 border-0 shadow overflow-hidden rounded-4 bg-white">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <a href="#" class="btn btn-danger text-white mt-3 w-100">
                            <i class="fas fa-calendar-alt"></i> {{ __('RESERVE') }}
                        </a>
                    </div>
                </div>
            </div>
