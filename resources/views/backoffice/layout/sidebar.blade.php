    ...
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <div class="sb-sidenav-menu-heading">ADMIN</div>
                ...
                @include('backoffice.widget.nav_link', ['url' => route('admin.testimonials.index'), 'icon' => 'fa-comment-dots', 'name' => 'sidebar.testimonial', 'ids' => 'testimonial-count'])
                @include('backoffice.widget.nav_link', ['url' => route('admin.tours.index'),'icon' => 'fa-globe-europe', 'name' => 'sidebar.tour', 'ids' => 'tour-count'])
                @include('backoffice.widget.nav_link', ['url' => route('admin.users.index'),'icon' => 'fa-users', 'name' => 'sidebar.user', 'ids' => 'user-count'])
        </div>
    </div>
</nav>
